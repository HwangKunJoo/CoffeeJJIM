 ...
 */
public class CafeProposalListRequest extends AbstractRequest<NetworkResult<List<Proposal>>> {

    Request request;
    public CafeProposalListRequest(Context context, String pageNo, String rowCount) {
